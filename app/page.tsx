...
export default function Home() {
  ...
  // Start with false to prevent loading skeleton flash - content renders immediately
  ...
  useEffect(() => {
    ...
    // Mark as visited for faster subsequent loads
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center bg-gradient-to-br from-mirage-950 via-mirage-900 to-mirage-950">
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "screenshot": "https://minigame.freakcloud.tk/images/og-image.png",
            "featureList": [
      ...
      {/* Subtle Background Grid - Static, GPU optimized */}
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
        ...
        <header className="relative pt-16 pb-8 px-2 sm:px-4">
          ...
          <div className="relative mt-2 sm:mt-4 ml-4 sm:ml-8 cursor-pointer w-fit">
            <span
            ...
            {puzzles.map((puzzle, index) => (
              <Link href={puzzle.href} key={puzzle.href} className="group">
                ...
                >
                  ...
                  <div className="absolute top-0 left-0 w-6 h-6 border-t border-l border-spring-green-500/30 group-hover:border-spring-green-400/80 transition-colors duration-300" />
                  <div className="absolute top-0 right-0 w-6 h-6 border-t border-r border-spring-green-500/30 group-hover:border-spring-green-400/80 transition-colors duration-300" />
                  <div className="absolute bottom-0 left-0 w-6 h-6 border-b border-l border-spring-green-500/30 group-hover:border-spring-green-400/80 transition-colors duration-300" />
                  <div className="absolute bottom-0 right-0 w-6 h-6 border-b border-r border-spring-green-500/30 group-hover:border-spring-green-400/80 transition-colors duration-300" />
                  ...
                  <div className="p-3 space-y-1 flex flex-col flex-grow">
                    <div className="relative pb-0.5">
                      ...
                      <div className="absolute bottom-0 left-0 h-px w-0 group-hover:w-full bg-gradient-to-r from-spring-green-400 to-transparent transition-all duration-300" />
                    </div>
        ...
        <div className="bg-gradient-to-br from-mirage-900/80 to-mirage-950/80 rounded-2xl shadow-xl p-8 sm:p-10 border-2 border-spring-green-500/30 hover:border-spring-green-400/60 transition-colors duration-300">
        ...
        {/* Highscores Section - removed backdrop-blur */}
        <div className="bg-gradient-to-br from-mirage-900/80 to-mirage-950/80 rounded-2xl shadow-xl p-8 sm:p-10 border-2 border-spring-green-500/30 text-center hover:border-spring-green-400/60 transition-colors duration-300">
        ...
        {/* Community Section - removed backdrop-blur */}
        <div className="bg-gradient-to-br from-mirage-900/80 to-mirage-950/80 rounded-2xl shadow-xl p-8 sm:p-10 border-2 border-spring-green-500/30 hover:border-spring-green-400/60 transition-colors duration-300">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 bg-gradient-to-r from-spring-green-400 to-aquamarine-400 bg-clip-text text-transparent">
