...
export const alt = 'Laundromat Hack Practice - NoPixel 4.0 Minigames'
export const size = {
  width: 1200,
  height: 630,
}
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Practice the laundromat ring alignment hack
          </div>
          <div
            style={{
              fontSize: '24px',
          ...
          >
            5 challenging levels • Beat the clock • Master the technique
          </div>
        </div>
        <div
          style={{
